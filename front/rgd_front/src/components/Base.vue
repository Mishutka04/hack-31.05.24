        ...
        <div class="col-12 height">
            <div class="row">
                <div class="col stat_block left">
                    <div class="stat_block_up">Рейтинг подразделения</div>
                    <div class="stat_block_down">
                        <div class="image icon"><img src="../assets/car_2.svg" alt="" ></div>
                ...
                <div class="col stat_block center">
                    ...
                    <div class="stat_block_down">
                        <div class="image icon"><img src="../assets/car_1.svg" alt=""></div>
                        <div class="stat_block_item">
                ...
                <div class="col stat_block center">
                    <div class="stat_block_up">Износ транспорта / Среднее (Подтверженные данные)</div>
                    <div class="stat_block_down">
                        <div class="image icon"><img src="../assets/calendar.svg" alt="" ></div>
                        <div class="stat_block_item">
                ...
                <div class="col stat_block right">
                    ...
                    <div class="stat_block_down">
                        <div class="image icon"><img src="../assets/raiting.svg" alt="" ></div>
                        <div class="stat_block_item">
                ...
                <div class="col stat_block right">
                    <div class="stat_block_up">Транспорт в структурном подразделении</div>
                    <div class="stat_block_down">
                        <div class="image icon"><img src="../assets/raiting.svg" alt="" ></div>
                        <div class="stat_block_item">
            ...
            <div class="row">
                <div class="col-4 ">
                    <div class="division_block division_block_bottom2">
                        <div class="division_title">Список автотранспорта</div>
                        <div class="line"></div>
                        <div class="division_items">
                            <div class="division_element" v-for="(line, index) in lines" :key='index'
                                ...
                                <div class="image">
                                    ...
                                    <div class="regions">Автотранспорт - {{ line.number }}</div>
                                </div>
                            </div>
                        </div>
